...
@section('content')
    ...
    <div class="col-md-10">
        ...
        <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"
              action="{{ url('/system/new_matter') }}">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">

            <div class="form-group">
                <label class="col-md-2 control-label"> Matter Name</label>
                <div class="col-md-3">
                    <input type="text" class="form-control" name="matter_name" value="{{ old('matter_name') }}">
                </div>
                <label class="col-md-2 control-label"> Matter Type</label>
                <div class="col-md-3">
            ...
            <div class="form-group">
                <label class="col-md-2 control-label">File Opening Date</label>
                <div class="col-md-3">
